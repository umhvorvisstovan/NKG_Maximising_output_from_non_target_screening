...
The compounds detected by GCxGC-MS (in biota) will be quantified to the extent possible (without internal standards per se, i.e. crude estimate from peak area).
